...
- **Cuerpo rojo** → cierre menor que la apertura (bajada de precio).  
- **Sombras (líneas)** → máximos y mínimos diarios.

El objetivo de la visualización es mostrar la evolución del precio de la acción de Apple y sus fluctuaciones durante un periodo anual.
